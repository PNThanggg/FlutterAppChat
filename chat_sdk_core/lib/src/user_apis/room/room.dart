...
class RoomApi {
  ...
  Future openChatWith({
    ...
    if (localRoom != null) {
      VChatController.I.vNavigator.messageNavigator.toMessagePage(buildContext, localRoom);
    } else {
      final apiRoom = await _vNativeApi.remote.room.getPeerRoom(peerId);
      VChatController.I.vNavigator.messageNavigator.toMessagePage(buildContext, apiRoom);
    }
  }

...
class VMessageNavigator {
  ...
  VMessageNavigator copyWith({
    ...
    return VMessageNavigator(
      toSingleChatMessageInfo: toSingleChatMessageInfo ?? this.toSingleChatMessageInfo,
      toGroupChatMessageInfo: toGroupChatMessageInfo ?? this.toGroupChatMessageInfo,
      toBroadcastChatMessageInfo: toBroadcastChatMessageInfo ?? this.toBroadcastChatMessageInfo,

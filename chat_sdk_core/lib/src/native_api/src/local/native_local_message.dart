...
class NativeLocalMessage {
  ...
  NativeLocalMessage(Database? database) {
    _localMessageRepo = VPlatforms.isWeb ? MemoryMessageImp() : SqlMessageImp(database!);
  }
  ...
  Future<int> prepareMessages() async => _localMessageRepo.updateMessagesFromSendingToError();
  ...
  Future<VBaseMessage?> getMessageByLocalId(String localId) async => _localMessageRepo.findByLocalId(localId);
  ...
  Future<int> updateMessagesFromSendingToError() async => _localMessageRepo.updateMessagesFromSendingToError();

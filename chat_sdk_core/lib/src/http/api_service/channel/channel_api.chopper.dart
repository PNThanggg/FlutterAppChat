...
final class _$ChannelApi extends ChannelApi {
  ...
  @override
  Future<Response<dynamic>> getWorkspace(Map<String, dynamic> query) {
    final Uri $url = Uri.parse('channel/workspace');
    final Map<String, dynamic> $params = query;
    final Request $request = Request(
      'GET',
      $url,
  ...
  @override
  Future<Response<dynamic>> getList(Map<String, dynamic> query) {
    final Uri $url = Uri.parse('channel/list');
    final Map<String, dynamic> $params = query;
    final Request $request = Request(
      'GET',
      $url,

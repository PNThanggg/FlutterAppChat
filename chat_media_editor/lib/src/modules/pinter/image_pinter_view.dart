...
class _ImagePinterViewState extends State<ImagePinterView> {
  ...
  Future<void> initBackground() async {
    ...
    if (widget.platformFileSource.bytes != null) {
      ...
      image = await FileImage(File(widget.platformFileSource.fileLocalPath!)).image;
    }
              ...
              actions: [
                IconButton(
                  ...
                  onPressed: painterController.selectedObjectDrawable != null &&
                          painterController.selectedObjectDrawable is ImageDrawable
                      ...
                      child: Column(
                        ...
                        children: [
                          if (painterController.freeStyleMode != FreeStyleMode.none) ...[
                            const Row(),
                            if (painterController.freeStyleMode == FreeStyleMode.draw)
                              Row(
                                children: [
                                  Expanded(child: "Color".h6),
                                  ...
                                  Expanded(
                                    ...
                                    child: Slider.adaptive(
                                      ...
                                      activeColor: painterController.freeStyleColor,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Slider.adaptive(
                                    min: 8,
                                    max: 96,
                                    value: painterController.textStyle.fontSize ?? 14,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Slider.adaptive(
                                    ...
                                    activeColor: painterController.textStyle.color,
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Slider.adaptive(
                                    min: 2,
                                    max: 25,
                                    value: painterController.shapePaint?.strokeWidth ?? shapePaint.strokeWidth,
                                    onChanged: (value) => setShapeFactoryPaint(
                                      (painterController.shapePaint ?? shapePaint).copyWith(
                                        strokeWidth: value,
                                      ),
                                    ),
                                  ),
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Slider.adaptive(
                                    max: 359.99,
                                    value: HSVColor.fromColor(
                                      (painterController.shapePaint ?? shapePaint).color,
                                    ).hue,
                                    activeColor: (painterController.shapePaint ?? shapePaint).color,
                            ...
                            Row(
                              children: [
                                ...
                                Expanded(
                                  ...
                                  child: Center(
                                    child: Switch(
                                      value: (painterController.shapePaint ?? shapePaint).style == PaintingStyle.fill,
                                      onChanged: (value) => setShapeFactoryPaint(
                                        (painterController.shapePaint ?? shapePaint).copyWith(
      ...
      bottomNavigationBar: ValueListenableBuilder(
        ...
        builder: (context, _, __) => Row(
          ...
          children: [
            ...
            IconButton(
              icon: Icon(
                PhosphorIconsLight.scribbleLoop,
              ...
              PopupMenuButton<ShapeFactory?>(
                ...
                child: Padding(
                  ...
                  child: Icon(
                    ...
                    color: painterController.shapeFactory != null ? Theme.of(context).colorScheme.secondary : null,
                  ),
                ),
              )
            else
  ...
  void toggleFreeStyleErase() {
    painterController.freeStyleMode =
        painterController.freeStyleMode != FreeStyleMode.erase ? FreeStyleMode.erase : FreeStyleMode.none;
  }
  ...
  Future<void> renderAndDisplayImage(BuildContext context) async {
    ...
    final ui.Image image = await painterController.renderImage(backgroundImageSize);
  ...
  static IconData getShapeIcon(ShapeFactory? shapeFactory) {
    if (shapeFactory is LineFactory) return PhosphorIconsLight.lineSegment;
    if (shapeFactory is ArrowFactory) return PhosphorIconsLight.arrowUpRight;
    if (shapeFactory is DoubleArrowFactory) {
      return PhosphorIconsLight.arrowsHorizontal;
    }
    if (shapeFactory is RectangleFactory) return PhosphorIconsLight.rectangle;
    if (shapeFactory is OvalFactory) return PhosphorIconsLight.circle;
    return PhosphorIconsLight.polygon;
  }
  ...
  void setFreeStyleColor(double hue) {
    painterController.freeStyleColor = HSVColor.fromAHSV(1, hue, 1, 1).toColor();
  }

  void toggleFreeStyleDraw() {
    painterController.freeStyleMode =
        painterController.freeStyleMode != FreeStyleMode.draw ? FreeStyleMode.draw : FreeStyleMode.none;
  }

  void setTextColor(double hue) {
    painterController.textStyle =
        painterController.textStyle.copyWith(color: HSVColor.fromAHSV(1, hue, 1, 1).toColor());
  }
  ...
  void setTextFontSize(double size) {
    ...
    setState(() {
      painterController.textSettings = painterController.textSettings.copyWith(
        textStyle: painterController.textSettings.textStyle.copyWith(fontSize: size),
      );
    });
  }

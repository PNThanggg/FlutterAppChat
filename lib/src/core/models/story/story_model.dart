...
class StoryModel {
  ...
  int? get colorValue => backgroundColor == null ? null : int.parse(backgroundColor!, radix: 16);
...
class UserStoryModel {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is UserStoryModel && runtimeType == other.runtimeType && userData == other.userData;

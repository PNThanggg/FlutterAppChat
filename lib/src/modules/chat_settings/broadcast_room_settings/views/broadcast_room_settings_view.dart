...
class BroadcastRoomSettingsView extends StatefulWidget {
  ...
  const BroadcastRoomSettingsView({
    super.key,
    required this.settingsModel,
  });

  @override
  State<BroadcastRoomSettingsView> createState() => _BroadcastRoomSettingsViewState();
}
                          ...
                          CupertinoListSection.insetGrouped(
                            ...
                            children: [
                              SettingsListItemTile(
                                ...
                                additionalInfo: Text(controller.settingsModel.title),
                              ),
                              SettingsListItemTile(
                                color: Colors.cyan,
                                ...
                                additionalInfo: Text(controller.info.totalUsers.toString()),
                              ),
                              SettingsListItemTile(
                                color: Colors.green,
                                onTap: () {
                                  controller.addParticipantsToBroadcast(context);
                                },

        ...
        headerSliverBuilder: (context, innerBoxIsScrolled) => [
          CupertinoSliverNavigationBar(
            largeTitle: Text(
              ...
              style: Theme.of(context).textTheme.bodyLarge?.copyWith(fontSize: 28, fontWeight: FontWeight.bold),
            ),
          )
        ],
            ...
            children: [
              Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    S.of(context).chooseHowAutomaticDownloadWorks.text.color(Colors.grey),
                    Row(
                      children: [

            ...
            return Row(
              children: [
                SizedBox(
                  ...
                  child: Padding(
                    padding: isSmall ? const EdgeInsets.all(10) : const EdgeInsets.all(15.0),
                    child: WideRoomsNavigation(
                      ...
                      onCreateNewBroadcast: () {
                        controller.createNewBroadcast(WideRoomsNavigation.navKey.currentState!.context);
                      },
                      onCreateNewGroup: () {
                        controller.createNewGroup(WideRoomsNavigation.navKey.currentState!.context);
                      },
                      onNewChat: () {

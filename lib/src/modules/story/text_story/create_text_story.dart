...
class _CreateTextStoryState extends State<CreateTextStory> {
          ...
          children: [
              ...
              child: Center(
                child: CupertinoTextField(
                  ...
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 35,
                    fontStyle: state.fontType == StoryFontType.italic ? FontStyle.italic : null,
                    textBaseline: TextBaseline.alphabetic,
                    fontWeight: state.fontType == StoryFontType.bold ? FontWeight.bold : null,
                  ),
            ...
            Container(
              ...
              child: ListTile(
                dense: false,
                contentPadding: const EdgeInsets.symmetric(horizontal: 10),
                title: S.of(context).shareYourStatus.text.color(Colors.grey).size(14),
                trailing: InkWell(
  ...
  void _randomFontType() {
    state.fontType = StoryFontType.values[random.nextInt(StoryFontType.values.length)];
    setState(() {});
  }

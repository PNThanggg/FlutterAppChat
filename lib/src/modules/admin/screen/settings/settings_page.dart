                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CheckboxListTile(
                            ...
                            subtitle: Text(
                              S.of(context).ifThisOptionEnabledTheVideoAndVoiceCallWillBeAllowed,
                            ),
                          ),
                          const Divider(
                            height: 10,
                          ...
                          CheckboxListTile(
                            ...
                            subtitle: Text(
                              S.of(context).ifThisOptionEnabledTheGoogleAdsBannerWillAppearInChats,
                            ),
                          ),
                          const Divider(
                            height: 10,
                          ...
                          CheckboxListTile(
                            ...
                            subtitle: Text(
                              S.of(context).ifThisOptionDisabledTheMobileLoginOrRegisterWillBeBlockedOnAndroidIosOnly,
                            ),
                          ),
                          const Divider(
                            height: 10,
                          ...
                          CheckboxListTile(
                            ...
                            subtitle: Text(
                              S.of(context).ifThisOptionDisabledTheWebLoginOrRegisterWillBeBlocked,
                            ),
                          ),
                          const Divider(
                            height: 10,
                          ...
                          CheckboxListTile(
                            ...
                            onChanged: (value) {
                              controller.updateAllowDesktopLogin(value ?? false);
                            },
                            title: Text(S.of(context).allowDesktopLogin),
                            subtitle: Text(
                              S.of(context).ifThisOptionDisabledTheDesktopLoginOrRegisterWindowsMacWillBeBlocked,
                            ),
                          ),
                          const Divider(
                            height: 10,
                          ...
                          CheckboxListTile(
                            ...
                            subtitle: Text(
                              S.of(context).ifThisOptionDisabledTheCreateChatGroupsWillBeBlocked,
                            ),
                          ),
                          const Divider(
                            height: 10,
                          ...
                          CheckboxListTile(
                            ...
                            onChanged: (value) {
                              controller.updateAllowCreateBroadcast(value ?? false);
                            },
                            title: Text(S.of(context).allowCreateBroadcast),
                            subtitle: Text(
                              S.of(context).ifThisOptionDisabledTheCreateChatBroadcastWillBeBlocked,
                            ),
                          ),
                          const Divider(
                            height: 10,
                          ...
                          CheckboxListTile(
                            ...
                            subtitle: Text(
                              S.of(context).ifThisOptionDisabledTheSendChatFilesImageVideosAndLocationWillBeBlocked,
                            ),
                          ),
                          const Divider(
                            height: 10,
                          ...
                          ListTile(
                            title: S.of(context).setMaxMessageForwardAndShare.text,
                            subtitle: "${value.data.maxForward} ${S.of(context).messages}".toString().text,
                          ...
                          ListTile(
                            ...
                            subtitle: "${value.data.maxExpireEmailTime} ${S.of(context).minutes}".toString().text,
                          ...
                          ListTile(
                            ...
                            subtitle: "${value.data.callTimeout ~/ 1000} ${S.of(context).seconds}".toString().text,
                          ...
                          ListTile(
                            ...
                            subtitle: "${value.data.maxGroupMembers} ${S.of(context).members}".toString().text,
                          ...
                          ListTile(
                            ...
                            subtitle: "${value.data.maxBroadcastMembers} ${S.of(context).members}".toString().text,

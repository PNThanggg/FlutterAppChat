import 'package:chat_input_ui/chat_input_ui.dart';
import 'package:chat_sdk_core/chat_sdk_core.dart';

///labels available to translate
class MessagesInfoTrans {
  ...
  factory MessagesInfoTrans.fromEnglish() {
    return const MessagesInfoTrans(

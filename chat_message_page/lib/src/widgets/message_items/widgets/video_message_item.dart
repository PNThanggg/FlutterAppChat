  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        navigateToVideoPlayer.call(context, message);
      },
      child: ConstrainedBox(
        constraints: const BoxConstraints(
          maxWidth: 350,
        ...
        child: Stack(
          ...
          children: [
            Stack(
              ...
              children: [
                getBackground(context),
                if (message.isFileDownloaded && message.emitStatus.isServerConfirm) getPlayIcon(),
              ],
            ),
            getVideoAttWidget(),
    ...
    if (VPlatforms.isMobile) {
      VChatController.I.vNavigator.messageNavigator.toVideoPlayer(
        ...
        VPlatformFile.fromPath(
          fileLocalPath: VFileUtils.getLocalPath(message.localFilePathWithExt),
        ),
        !message.isOneSeen,
      );
      return;

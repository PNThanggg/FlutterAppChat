...
class StatusModelItem {
  ...
  static const dummyStatusModelItem = StatusModelItem(
    ...
    statusColor: "#00ff00",
    statusText: "we need to get the image from the server and then set the image url to the image url",
  );
  ...
  @override
  int get hashCode => url.hashCode ^ statusType.hashCode ^ statusText.hashCode ^ statusColor.hashCode;

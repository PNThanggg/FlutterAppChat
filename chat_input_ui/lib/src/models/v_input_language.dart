class VInputLanguage {
  ...
  const VInputLanguage({
    ...
    this.thereIsVideoSizeBiggerThanAllowedSize = "There is video size bigger than allowed size",
    this.thereIsFileHasSizeBiggerThanAllowedSize = "There is File has size bigger than allowed size",
  });
}
